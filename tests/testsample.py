...
class TaskModelTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.charity = Charity.objects.create(
            user=cls.user, name="charity", reg_number="5678901234"
        )
...
class TestAll(TestCase):
    def setUp(self):
        ...
        self.charity = Charity.objects.create(
            user=self.user, name="charity1", reg_number="1234567891"
        )
        self.charity_2 = Charity.objects.create(
            user=self.user_2, name="charity2", reg_number="1234567892"
        )
        self.charity_3 = Charity.objects.create(
            user=self.user_3, name="charity3", reg_number="1234567893"
        )
        self.charity_4 = Charity.objects.create(
            user=self.user_4, name="charity4", reg_number="1234567894"
        )
        ...
        Task.objects.create(
            ...
            state="P",
            charity=self.charity_3,
            assigned_benefactor=self.benefactor_4,
        )
